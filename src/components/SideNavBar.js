...
export default function SideNavBar({ showStars, setShowStars }) {
  ...
  return (
    <div className="side-navbar" ref={sideNavRef}>
      <a href="https://github.com/Yatharth-Vaish" title="GitHub" target="_blank" rel="noopener noreferrer" ref={addToRefs}>
        <Icon name="GitHub" className="sidenav-icon"/>
      </a>
      <a href="https://www.linkedin.com/in/yatharthvaish/" title="LinkedIn" target="_blank" rel="noopener noreferrer" ref={addToRefs}>
        <Icon name="Linkedin" className="sidenav-icon"/>
      </a>
      <a href="mailto:yatharthvaish@gmail.com" title="Email" target="_blank" rel="noopener noreferrer" ref={addToRefs}>
